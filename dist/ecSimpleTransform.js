(function (global, factory) {
    ...
    var lineUpdater = {
        ...
        'MIN': function (val, upstream, dataIndex, dimInfo, groupByDimInfo, groupByVal) {
            return Math.ceil(lineCreatorForQ(0.25, dimInfo, groupByDimInfo, groupByVal)
                - 1.5
                    * (lineCreatorForQ(0.75, dimInfo, groupByDimInfo, groupByVal)
                        - lineCreatorForQ(0.25, dimInfo, groupByDimInfo, groupByVal)));
        },
        'MAX': function (val, upstream, dataIndex, dimInfo, groupByDimInfo, groupByVal) {
            return Math.ceil(lineCreatorForQ(0.75, dimInfo, groupByDimInfo, groupByVal)
                + 1.5
                    * (lineCreatorForQ(0.75, dimInfo, groupByDimInfo, groupByVal)
                        - lineCreatorForQ(0.25, dimInfo, groupByDimInfo, groupByVal)));
        },
